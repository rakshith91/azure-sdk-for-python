...
class BodyModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModel(Model):
    ...
    :param id: The id property for the salesCreditMemoLine entity
    :type id: str
    :param document_id: The documentId property for the salesCreditMemoLine
     entity
    :type document_id: str
    :param sequence: The sequence property for the salesCreditMemoLine entity
    :type sequence: int
    :param item_id: The itemId property for the salesCreditMemoLine entity
    :type item_id: str
    :param account_id: The accountId property for the salesCreditMemoLine
     entity
    :type account_id: str
    :param line_type: The lineType property for the salesCreditMemoLine entity
    :type line_type: str
    :param line_details:
    :type line_details:
     ~azure.mgmt.devtestlabs.models.Documentlineobjectdetailstype
    :param description: The description property for the salesCreditMemoLine
     entity
    ...
    :param unit_price: The unitPrice property for the salesCreditMemoLine
     entity
    :type unit_price: decimal.Decimal
    :param quantity: The quantity property for the salesCreditMemoLine entity
    ...
    :param tax_code: The taxCode property for the salesCreditMemoLine entity
    :type tax_code: str
    :param tax_percent: The taxPercent property for the salesCreditMemoLine
     entity
    ...
    :param net_amount: The netAmount property for the salesCreditMemoLine
     entity
    ...
    :param shipment_date: The shipmentDate property for the
     salesCreditMemoLine entity
    ...
    def __init__(self, *, id: str=None, document_id: str=None, sequence: int=None, item_id: str=None, account_id: str=None, line_type: str=None, line_details=None, description: str=None, unit_of_measure_id: str=None, unit_of_measure=None, unit_price=None, quantity=None, discount_amount=None, discount_percent=None, discount_applied_before_tax: bool=None, amount_excluding_tax=None, tax_code: str=None, tax_percent=None, total_tax_amount=None, amount_including_tax=None, invoice_discount_allocation=None, net_amount=None, net_tax_amount=None, net_amount_including_tax=None, shipment_date=None, **kwargs) -> None:
        super(BodyModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModel, self).__init__(**kwargs)
        self.id = id
