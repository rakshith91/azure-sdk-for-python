...
class BodyModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModel(Model):
    ...
    def __init__(self, *, id: str=None, number: str=None, external_document_number: str=None, credit_memo_date=None, due_date=None, customer_id: str=None, contact_id: str=None, customer_number: str=None, customer_name: str=None, bill_to_name: str=None, bill_to_customer_id: str=None, bill_to_customer_number: str=None, selling_postal_address=None, billing_postal_address=None, currency_id: str=None, currency_code: str=None, payment_terms_id: str=None, salesperson: str=None, prices_include_tax: bool=None, discount_amount=None, discount_applied_before_tax: bool=None, total_amount_excluding_tax=None, total_tax_amount=None, total_amount_including_tax=None, status: str=None, last_modified_date_time=None, invoice_id: str=None, invoice_number: str=None, phone_number: str=None, email: str=None, **kwargs) -> None:
        super(BodyModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModel, self).__init__(**kwargs)
        self.id = id
        self.number = number
