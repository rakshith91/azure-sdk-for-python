...
class BodyModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModelModel(Model):
    ...
    def __init__(self, *, id: str=None, number: str=None, invoice_date=None, due_date=None, vendor_invoice_number: str=None, vendor_id: str=None, vendor_number: str=None, vendor_name: str=None, pay_to_name: str=None, pay_to_contact: str=None, pay_to_vendor_id: str=None, pay_to_vendor_number: str=None, ship_to_name: str=None, ship_to_contact: str=None, buy_from_address=None, pay_to_address=None, ship_to_address=None, currency_id: str=None, currency_code: str=None, prices_include_tax: bool=None, discount_amount=None, discount_applied_before_tax: bool=None, total_amount_excluding_tax=None, total_tax_amount=None, total_amount_including_tax=None, status: str=None, last_modified_date_time=None, **kwargs) -> None:
