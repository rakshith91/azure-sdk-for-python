...
class PurchaseInvoiceLine(Model):
    """PurchaseInvoiceLine.
    ...
    def __init__(self, *, id: str=None, document_id: str=None, sequence: int=None, item_id: str=None, account_id: str=None, line_type: str=None, line_details=None, description: str=None, unit_of_measure=None, unit_cost=None, quantity=None, discount_amount=None, discount_percent=None, discount_applied_before_tax: bool=None, amount_excluding_tax=None, tax_code: str=None, tax_percent=None, total_tax_amount=None, amount_including_tax=None, invoice_discount_allocation=None, net_amount=None, net_tax_amount=None, net_amount_including_tax=None, expected_receipt_date=None, item=None, account=None, **kwargs) -> None:
        super(PurchaseInvoiceLine, self).__init__(**kwargs)
        self.id = id
